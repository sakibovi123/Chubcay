...
export default function TestimonialCard()
 {
    return (
        <div className="bg-white shadow-xl rounded-xl h-[360px] p-4 w-full">
            <div className="md:p-3 w-full md:flex items-center
             justify-between md:w-[520px] border-b-2">
                ...
                <div className="w-full md:mx-[-8rem] mx-1 p-3">
                    <p className="md:text-center text-left">Review</p>
                    <div className="flex items-center md:justify-center justify-start gap-1">
                        <CiStar />
                        <CiStar />
                        <CiStar />
                        <CiStar />
