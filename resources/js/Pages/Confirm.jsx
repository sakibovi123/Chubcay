    ...
    <div className="container mx-auto h-full w-full">
      <div className="flex flex-col items-center justify-center gap-5">
        <div className="w-[35%] bg-white p-[5rem] my-[12rem]">
            <h2 className="text-4xl text-center font-bold">SUCCESS</h2>
            <p className="text-center text-green-400 font-bold text-lg my-5">
                Your registration is now pending. Soon admin will approve your request
            </p>
