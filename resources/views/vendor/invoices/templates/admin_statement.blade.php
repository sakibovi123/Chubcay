            ...
            <thead>
                <tr>
                    ...
                    @if($invoice->hasItemUnits)
                        <th scope="col" class="text-center border-0">Membership duration</th>
                    @endif
            ...
            <tbody>
                ...
                <tr>
                    <td class="pl-0">
                        ...
                        @if($item->description)
                        @php
                        $features = json_decode($item->description)
                        @endphp
                        @foreach($features as $key=>$value)
                            <p class="cool-gray">{{$key}}: {{$value}}</p>
                    ...
                    @if($invoice->hasItemUnits)
                        ...
                        @elseif( $item->units == 183 )
                            <td class="text-center">Quaterly</td>
                        @elseif( $item->units == 365 )
                            <td class="text-center">Yealy</td>
                        @else
